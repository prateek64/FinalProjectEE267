...
class PoseTracker : public OrientationTracker {
  ...
  public:
     ...
     */
    int processLighthouse(float realXP, float realYP , float realF);
  ...
  protected:
     ...
     *           1: if successful.
     */
    int updatePose(float realXP, float realYP , float realF);
...
//
//    float realXP =  1.02794;
//    float realYP =-0.36875 ;
//    float realF  =  1.08789;
